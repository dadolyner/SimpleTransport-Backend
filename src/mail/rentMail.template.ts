    ...
    return `
        ...
        <body>
            <table>
                ...
                <tr><p style="margin:0"><span style="font-weight:bold">${userThatRented.first_name} ${userThatRented.last_name}</span> just reserved your ${car} between ${new Date(start_date).toLocaleDateString()} and ${new Date(end_date).toLocaleDateString()}</p></tr>
